...
const inputPeso = document.querySelector('#inputPeso') // Accedemos a los elementos del id #inputPeso
...
btnCalcular.addEventListener('click', function (event){
    ...
    // divResultado.innerText = ' Tu indice de Masa Corporal es ' + resultado + '. Y es ' + indiceDeMasaCorporal.toFixed(2) // toFixed para mostrar solo cierta cantidad de decimales
