...
// Método INCLUDES: includes, nos indica si el valor que se pasa como parámetro se encuentra en el arreglo y devuelve un booleano
...
console.log(
  languages.filter(
    function(language) {
      // return language === 'python' //resultado ['python', 'python']
      // return language.includes('c') // ['javascript', 'c++'] (No considera la c mayúscula)
      return language.toLowerCase().includes('c') // ['javascript', 'C', 'c++'] (transforma primero a minúsculas, sí considera la C mayúscula)
    }
  )
)
