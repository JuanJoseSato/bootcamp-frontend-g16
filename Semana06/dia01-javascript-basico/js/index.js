...
// OPERADOR DE CADENA (CONCATEACIÓN)
...
console.log(cadena1.length) // lenght=longitud de la cadena
...
// 3. Retornar True si un numero menor que 60 sino devolver False

const numero222 = 85

console.log(numero222 < 60)  // true
...
console.log(numero333 != 0 && numero333 % 2 === 0) // false
console.log(numero444 != 0 && numero444 % 2 === 0) // true

// 5. Retornar True si un numero impar sino devolver False

const numero555 = 5
const numero666 = 6

console.log(numero555 != 0 && numero555 % 2 !== 0) // false
console.log(numero666 != 0 && numero666 % 2 !== 0) // true

// 6. Calcular el área de un triángulo y mostrar su resultado si tenemos lo valores base y altura
const base = 10
const altura = 5
...
// 7. (OPCIONAL) Almacenar en una constante un número de 3 cifras y mostrar la suma de sus cifras elevada al cubo
/*
const numeroC4 = 192;
...
// 8. (OPCIONAL) Almacenar en una constante un monto de dinero, luego mostrar cuanto le toca a cada socio según la siguiente tabla:
...
switch (heroe) {
    ...
    case 'Ironman':
        ...
        break
    default:
        console.log('No soy un heroes aún')
}
...
// 1. Determinar si la edad de una persona es mayo de edad o menor de edad mostrando 'Mayo de edad' o 'Menor de edad'
...
// 1. Usando funciones determinar si la edad d euna persona es mayo de edad o menor de edad monstrando 'Mayor de edad' o'Menor de edad'

// Funciones sin retorno
function esMayorOMenorDeEdad(edad){
    if (edad >= 18) {
        console.log('Mayo de edad')
    } else {
        console.log('Menor de edad')
    }
}
